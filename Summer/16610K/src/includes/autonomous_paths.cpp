...
void leftAuton() 
{
    ...
    moveTo(-59, 0, 1000, 1000, true, true);

    moveTo(-59, -23, 1000, 1000, true, true);

    moveTo(-56.5, -23, 1200, 1000, false, false);
...
void rightAuton() 
{
    ...
    moveTo(0, -59, 1000, 1000, true, true);

    moveTo(-23, -59, 1000, 1000, true, true);
